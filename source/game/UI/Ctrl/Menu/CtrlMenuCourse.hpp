...
static_assert(sizeof(CourseButton) == 0x26c,"CourseButton");
...
static_assert(sizeof(CtrlMenuCourseSelectCup) == 0xdd4, "CtrlMenuCourseSelectCup");
...
static_assert(sizeof(CtrlMenuCourseSelectCourse) == 0xcc0, "CtrlMenuCourseSelectCourse");
