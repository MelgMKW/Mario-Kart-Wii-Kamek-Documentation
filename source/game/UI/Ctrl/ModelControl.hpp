...
static_assert(sizeof(BackGroundModelControl) == 0x180,"BackGroundModelControl");
...
static_assert(sizeof(NoteModelControl) == 0x180,"NoteModelControl");
...
static_assert(sizeof(VehicleModelControl) == 0x184,"VehicleModelControl");
...
static_assert(sizeof(DriverModelControl) == 0x188,"DriverModelControl");
#endif