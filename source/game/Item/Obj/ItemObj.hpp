...
public:
    ...
    virtual bool SetInitialPosition(ItemPlayer *player); //0x20 8079dcb4 returns 1 if it's a forward throw
    ...
    static void GetQuatFromMat(Quat *dest, Mtx34 *src); //807b9dd4 probably global or another class
...
public:
    ...
    void Spawn(ItemObjId objId, u8 playerId, bool r7); //8079e550
...
public:
    ...
    void Spawn(u32 quantity, ItemObj *usedObj, u8 playerId, Vec3 *playerPos, bool r8); //80795e04 usedObj is filled by the function
    ItemObjId itemObjId;
    ItemObj **itemObj;
